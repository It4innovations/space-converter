...
#include <vector>
 ...
 // Namespace gadget provides functionalities for handling Gadget simulation data.
namespace gadget {

    // Namespace io contains I/O operations and utilities for Gadget data processing.
    namespace io {

        // Print the steps executed on the CPU during the Gadget simulation process.
        ...
        // Initialize the Gadget library.
        void gadget_init_lib(int world_rank, int world_size);

        // Finalize and clean up the Gadget library.
        void gadget_finish_lib();

        // Set parameters for the Gadget simulation.
        ...
        // Read a parameter file for Gadget simulation.
        ...
        // Initialize memory allocation for Gadget simulation.
        void gadget_mymalloc_init();

        // Set simulation units for Gadget data.
