...
#AR_GREEN_TREE_FOF
#AR_GREEN_TREE_PROCESS_FIRST_PARTICLE_ALONE
#AR_GREEN_TREE_MAX_GROUP_SIZE=200
#AR_GREEN_TREE_HSML_FRACTION=0.4
...
#KD_TREEDOMAIN_UPDATE_FREQENCY  # Modifies the upate frequency wit 1/a
#RECOMPOSE_DOMAIN              
#RECOMPOSE_DOMAIN_FACTOR=6      # Frequency of short domain decomposition 
...
WENDLAND_C4_KERNEL        # Switch to Wendland C6 kernel
WC4_BIAS_CORRECTION       # Apply the bias correction for C6
...
GMMV_MUPPI_NOWU 
MV_GM_STELLAR_KIN_FB2                    #Valentini+2017 FB2 Kinetic feedback model
#MV_GM_STELLAR_KIN_FB2_OUTPUT            #Additional output for FB2
COUNT_PARTICLES_IN_CONE                  #MUPPI statistics
