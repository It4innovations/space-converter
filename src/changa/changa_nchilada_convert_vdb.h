...
#include "convert_vdb.h"
 ...
 // Namespace changa contains classes and functionality for handling VDB data in Changa and nchilada format.
namespace changa {
    ...
    public:
        ...
        // Determine the type of a particle based on its unique identifier.
        // @param id: The unique identifier of the particle.
        // @return An integer representing the particle type.
        int get_particle_type(uint64_t id) override;

        // Get the position of a particle in 3D space.
        // @param id: The unique identifier of the particle.
        ...
        // Get the number of particles on the local node.
    ...
    }; // class ConvertVDBChangaNchilada
