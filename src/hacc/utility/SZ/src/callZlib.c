...
unsigned long long zlib_compress(unsigned char* data, unsigned long long dataLength, unsigned char** compressBytes, int level)
{	
	z_stream stream = {0};
...
unsigned long long zlib_compress2(unsigned char* data, unsigned long long dataLength, unsigned char** compressBytes, int level)
{
...
unsigned long long zlib_compress3(unsigned char* data, unsigned long long dataLength, unsigned char* compressBytes, int level)
{
...
unsigned long long zlib_compress4(unsigned char* data, unsigned long long dataLength, unsigned char** compressBytes, int level)
{
...
unsigned long long zlib_compress5(unsigned char* data, unsigned long long dataLength, unsigned char** compressBytes, int level)
{
	int ret, flush;
	unsigned have;
	z_stream strm;
...
unsigned long long zlib_uncompress(unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize)
{
...
unsigned long long zlib_uncompress2 (unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize)
{
    z_stream stream = {0};
...
//	stream.data_type = Z_TEXT;
    ...
    /* Check for source > 64K on 16-bit machine: */
    if ((unsigned long long)stream.avail_in != cmpSize) 
    {
...
unsigned long long zlib_uncompress3(unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize)
{
	int status;
...
unsigned long long zlib_uncompress4(unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize)
{
    int ret;
    unsigned int have;
    z_stream strm;
...
unsigned long long zlib_uncompress65536bytes(unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData)
{
	int err;
	unsigned long long targetOriSize = 65536;
...
unsigned long long zlib_uncompress5(unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize)
{
	int err;
	z_stream d_stream = {0}; /* decompression stream */
