...
#include <vector>
 ...
 // Namespace genericio provides functionalities for handling GenericIO data.
namespace genericio {

    // Enum defining particle types in the Tipsy format.
    enum GenericIOParticleType {
        HACC = 0,
    ...
    // Namespace io contains I/O operations and utilities for GenericIO data processing.
    namespace io {

        // Print the steps executed on the CPU during the GenericIO process.
        ...
        // Initialize the GenericIO library.
        ...
        // Finalize and clean up the GenericIO library.
        void finish_lib();

        // Set parameters for the GenericIO.
        ...
        //void genericio_set_parameter(int ICFormat, int SnapFormat, int NumFilesWrittenInParallel, int MaxMemSize, double BufferSize, double PartAllocFactor, int TotBHs);

        // Read a parameter file for GenericIO.
        ...
        //void genericio_read_parameter_file(char* fname, char* tag[], void** addr, int* id, int nt);

        // Read initial condition data from a file.
        // @param fname: Name of the file containing initial conditions.
        //void genericio_read_ic(std::string fname);

        // Initialize memory allocation for GenericIO.
        //void genericio_mymalloc_init();

        // Set units for GenericIO data.
        //void genericio_set_units();
