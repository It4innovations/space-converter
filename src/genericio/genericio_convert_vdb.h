...
namespace genericio {
    ...
    // ConvertVDBGenericIO is a derived class from common::vdb::ConvertVDBBase.
    // This class implements methods for converting particle data from GenericIO/Excel format into VDB format.
    class ConvertVDBGenericIO : public common::vdb::ConvertVDBBase {
    public:
