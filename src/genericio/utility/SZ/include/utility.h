...
unsigned long long sz_lossless_compress(int losslessCompressor, int level, unsigned char* data, unsigned long long dataLength, unsigned char** compressBytes);
unsigned long long sz_lossless_decompress(int losslessCompressor, unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData, unsigned long long targetOriSize);
unsigned long long sz_lossless_decompress65536bytes(int losslessCompressor, unsigned char* compressBytes, unsigned long long cmpSize, unsigned char** oriData);
