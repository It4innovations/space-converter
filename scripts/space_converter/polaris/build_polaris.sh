...
output=${ROOT_DIR}/install/space_converter_polaris
src=${ROOT_DIR}/src
...
#/opt/nvidia/hpc_sdk/Linux_x86_64/23.9/compilers/bin/nvcc

#export CC='mpicc'
#export CXX='mpic++'

#rm -rf build/space_converter_polaris

#-----------space_converter--------------
mkdir ${ROOT_DIR}/build/space_converter_polaris
cd ${ROOT_DIR}/build/space_converter_polaris
...
make_d="${make_d} -DOPENVDB_LIBRARIES=$lib_dir/openvdb/lib64/libopenvdb.so;$lib_dir/tbb/lib64/libtbb.so"
