...
output=${ROOT_DIR}/install/space_converter_lumi_hip
src=${ROOT_DIR}/src
...
#rm -rf ${ROOT_DIR}/build/space_converter_lumi_hip

#-----------space_converter_lumi_hip--------------
mkdir -p ${ROOT_DIR}/build/space_converter_lumi_hip
cd ${ROOT_DIR}/build/space_converter_lumi_hip
...
#----------------HIP (AMD GPU)----------------
make_d="${make_d} -DWITH_GPU_HIP=ON"
make_d="${make_d} -DWITH_HIP_AWARE_MPI=ON"
